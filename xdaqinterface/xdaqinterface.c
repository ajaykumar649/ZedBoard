...
struct sockaddr_in setupSocketAddress(const char* ip, unsigned int port)
{
    ...
    if(inet_aton(ip, &socketAddress.sin_addr) == 0)
    {
        ...
        printf("FATAL: Invalid IP address %s\n",ip);
        exit(0);
    }
...
//========================================================================================================================
int send(int fromSocket, struct sockaddr_in& toSocketAddress, const char &buffer)
{
    printf("Socket Descriptor #: %d\n",fromSocket);
    printf("ip:%s\n",toSocketAddress.sin_addr.s_addr);
    printf("port:%d\n",toSocketAddress.sin_port);
...
//========================================================================================================================
int receive(int socketNumber, char &buffer, struct sockaddr_in& fromAddress)
{
	struct timeval tv;
	tv.tv_sec = 2;
